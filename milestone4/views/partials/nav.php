        ...
        <div class="flex h-16 items-center justify-between">
            <div class="flex items-center">
                <div class="flex-shrink-0">
                    <img class="h-8 w-8" src="<?=getRoot()?>/logo.png" alt="Your Company">
                </div>
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        { ?>
                         <a href="orders"
                            class="<?= urlIs('/orders') ?  "bg-gray-900 text-red-500" : "text-gray-300"; ?> hover:bg-gray-700 hover:text-white rounded-md px-3 py-2 text-sm font-medium">
                            Orders</a>  
                        <?php } ?> 
                    </div>
                </div>
                ...
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    <form action="" method="POST">
                        <?php if(isset($_SESSION['username'])) { ?>
                            <button type="submit" name="logout" class="text-white ml-5 bg-gray-900 p-2"> 
                                Logout
                            </button>
                        <?php } ?>
                    </form>
